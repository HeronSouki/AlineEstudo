...
const QUIZ_QUESTIONS = [
  {
    id: 1,
    question: "Quais são direitos básicos previstos no CDC?",
    options: [
    ...
    lawRef: "CDC, art. 6º",
    explanation:
      "O art. 6º do CDC elenca direitos básicos do consumidor, como proteção à vida, informação clara, educação para consumo, prevenção a publicidade enganosa e acesso à justiça.",
  },
  {
    id: 2,
    question: "O que o CDC prevê quando o produto apresenta vício de qualidade?",
    options: [
    ...
    lawRef: "CDC, art. 18",
    explanation:
      "Se o vício não for sanado em até 30 dias, o consumidor pode optar entre substituição, restituição da quantia paga ou abatimento proporcional do preço (art. 18).",
  },
  {
    id: 3,
    question: "A oferta vincula o fornecedor?",
    options: [
      "Não, ofertas são apenas sugestões",
      "Sim, a oferta integra o contrato e deve ser cumprida",
      "Só vincula em promoções de TV",
      "Apenas quando registrada em cartório",
    ],
    correctIndex: 1,
    lawRef: "CDC, arts. 30 e 35",
    explanation:
      "A oferta, suficientemente precisa, obriga o fornecedor. O descumprimento permite exigir o cumprimento forçado, aceitar equivalente ou rescindir com restituição (arts. 30 e 35).",
  },
  {
    id: 4,
    question: "Qual é o prazo para reclamar de vício aparente em produto não durável?",
    options: ["30 dias", "90 dias", "7 dias", "15 dias"],
    correctIndex: 0,
    lawRef: "CDC, art. 26, I",
    explanation:
      "Para bens não duráveis, o prazo é de 30 dias; para duráveis, 90 dias. O prazo conta do recebimento do produto (art. 26).",
  },
  {
    id: 5,
    question: "Direito de arrependimento em compras fora do estabelecimento?",
    options: [
      "Não existe no Brasil",
      "7 dias a partir do recebimento ou assinatura, com devolução de valores",
      "Somente 24 horas após a compra",
      "Apenas se o produto for importado",
    ],
    correctIndex: 1,
    lawRef: "CDC, art. 49",
    explanation:
      "No prazo de 7 dias, o consumidor pode desistir da compra realizada fora do estabelecimento (internet, telefone), com devolução imediata dos valores (art. 49).",
  },
  {
    id: 6,
    question: "É válida cláusula contratual que coloca o consumidor em desvantagem exagerada?",
    options: ["Sim, se assinado", "Não, é nula de pleno direito", "Depende do valor", "Somente em serviços públicos"],
    correctIndex: 1,
    lawRef: "CDC, art. 51",
    explanation:
      "Cláusulas abusivas que coloquem o consumidor em desvantagem exagerada são nulas de pleno direito (art. 51).",
  },
  {
    id: 7,
    question: "Prática de vender produto sem informar claramente preço e características é…",
    options: [
      "Permitida, se o produto for popular",
      "Prática abusiva por falha de informação",
      "Aceitável em marketplaces",
      "Permitida quando o site é internacional",
    ],
    correctIndex: 1,
    lawRef: "CDC, arts. 6º, III e 31",
    explanation:
      "Informação adequada, clara e ostensiva é direito básico. A falta configura prática abusiva (arts. 6º, III e 31).",
  },
  {
    id: 8,
    question: "Cobrança de dívida com constrangimento ou ameaça é…",
    options: [
      "Permitida para agilizar pagamento",
      "Proibida como prática abusiva",
      "Obrigatória antes de negativar",
      "Apenas antiética, mas legal",
    ],
    correctIndex: 1,
    lawRef: "CDC, art. 42",
    explanation:
      "O CDC veda métodos de cobrança que exponham o consumidor ao ridículo ou ameaça/coação (art. 42).",
  },
];

const FLASHCARDS_DEFAULT = [
  {
    front: "Art. 6º – Direitos Básicos",
    back: "Vida/saúde/segurança, informação clara, educação para consumo, proteção contra publicidade enganosa e abusiva, acesso à justiça.",
  },
  {
    front: "Art. 18 – Vício do Produto/Serviço",
    back: "Prazo de 30 dias para sanar vício; depois, escolha do consumidor: substituição, restituição ou abatimento do preço.",
  },
  {
    front: "Art. 30 e 35 – Oferta e Descumprimento",
    back: "Oferta vincula o fornecedor. Não cumpriu? Consumidor pode exigir cumprimento, aceitar equivalente ou rescindir com devolução.",
  },
  {
    front: "Art. 26 – Prazos para Reclamar",
    back: "Não duráveis: 30 dias. Duráveis: 90 dias. Conta do recebimento/entrega do serviço.",
  },
  { front: "Art. 49 – Arrependimento", back: "7 dias para desistir de compra fora do estabelecimento, com devolução dos valores." },
  {
    front: "Art. 51 – Cláusulas Abusivas",
    back: "São nulas de pleno direito as cláusulas que coloquem o consumidor em desvantagem exagerada ou contrariem a boa-fé.",
  },
];
...
const POEMAS_BASE = [
  {
    lei: "CDC, art. 6º",
    tema: "direitos básicos",
    resumo:
      "Proteção à vida e à informação; clareza e segurança no consumo; justiça acessível e respeito ao cidadão.",
  },
  {
    lei: "CDC, art. 18",
    tema: "vício do produto",
    resumo:
      "Se o vício persiste, a escolha é tua: trocar, devolver ou abater — a lei te ampara na rua.",
  },
  {
    lei: "CDC, arts. 30/35",
    tema: "oferta e cumprimento",
    resumo:
      "Palavra dada é contrato. Oferta não é promessa vazia: é dever firmado na via.",
  },
  { lei: "CDC, art. 49", tema: "arrependimento", resumo: "Sete dias para pensar, sem pressa nem aperto: voltar atrás é direito certo." },
  {
    ...
    resumo:
      "Não vale o que oprime, nem cláusula que humilha: ao consumidor, justiça brilha.",
  },
  {
    lei: "CDC, art. 42",
    tema: "cobrança",
    resumo: "Cobrar sem constranger, exigir sem ameaçar: respeito é regra que a lei faz valer.",
  },
];
              ...
              {q.options.map((opt, i) => {
                ...
                return (
                  <Button
                    ...
                    className="justify-start h-auto whitespace-normal text-left rounded-xl"
...
function PoemaSection() {
  ...
  const { lei, tema, resumo } = POEMAS_BASE[dayIndex];

  const poema = useMemo(() => {
    const linhas = [
      `Aline, na trilha do justo saber,`,
      `no ${lei}, a luz pra te defender;`,
      `${resumo}`,
  ...
  return (
    <Card>
      <CardHeader><CardTitle className="flex items-center gap-2"><Sparkles className="h-5 w-5" /> Poema do dia — {lei} ({tema})</CardTitle></CardHeader>
      <CardContent>
