...
export function Tabs({ defaultValue, children }: { defaultValue: string, children: React.ReactNode }) {
  ...
  return <div data-tabs-value={value}>{React.Children.map(children as any, (child: any) => {
...
export function TabsList({ children, value, onChange }: { children: React.ReactNode, value?: string, onChange?: (v: string)=>void }) {
  return <div className="tabs-list">{React.Children.map(children as any, (child: any) => React.cloneElement(child, { activeValue: value, onChange }))}</div>;
}
